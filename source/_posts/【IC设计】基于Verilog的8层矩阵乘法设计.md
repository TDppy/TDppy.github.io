...
![在这里插入图片描述](/images/45a06b0e65b752626d69cdda865ce2b1.png)
...
![在这里插入图片描述](/images/917fc692deb02e4b3e4c273441f9451d.png)
...
如果符号位为1，直接截断。
这个操作的正确性证明如下：
![在这里插入图片描述](/images/4cd3dc52f86216dfec218664ee2e7719.png)
...
这里给出第一层和最后一层（第八层）的输出作为参考，需要注意的是矩阵A*B和B*A结果是不同的，这里第一层的结果是Weight I~0~在左边乘以Input ~-1~ ，得到的Input ~0~ 
 ![在这里插入图片描述](/images/f0728dd927c7b46c4613ee1ce922274b.png)
![在这里插入图片描述](/images/87df88ca235983d30e880b7c2b490c30.png)
...
![在这里插入图片描述](/images/1941fd4971b8b03ce81a235dd63d1222.png)
...
```
可以看到输出和参考结果的图一致
![在这里插入图片描述](/images/3e2a1bf77c06ab8c52bc0f8df66d2a23.png)
参考结果：
![在这里插入图片描述](/images/3ebe911641ec23787d3bea83fdb6d0ed.png)
...
![在这里插入图片描述](/images/9837e7874dc7cc142112a913ec1dc8c9.png)
`write_sdf ./matrix_multiplier_16.sdf`执行结果：
![在这里插入图片描述](/images/b5c2c0e6f2415bb18a39c92e3823206f.png#pic_center)
...
```
后方跑完截图
![在这里插入图片描述](/images/2ccce9ac3eed344f80af96ed737e02d5.png)
