...
### ①什么是互联网络？
互联网络是终端之间传输数据的可编程系统。
![在这里插入图片描述](ed0ac9e38ff69a220bb3add8c261582d.png)
...
![在这里插入图片描述](e838227732846c6af2509997f25ed7b0.png)
### ④互联网络的参数有哪些
1. 终端数量
2. 每个终端的峰值带宽
3. 每个终端的平均带宽
...
![在这里插入图片描述](ef5bd7f3091e3122a5fa3887ed566d6d.png)
### NoC相比于总线架构的优势
...
- 支持多个IP并行交互，通信效率高；
### NoC常见的拓扑结构
![在这里插入图片描述](187b622eeeb698eca733af5f199b9735.png)
...
![在这里插入图片描述](e9191d5b4044c38d8b25be23f366574b.png)
...
![在这里插入图片描述](de788f7884a5843f67ab67956526ac49.png)
#### 蝶状结构
该结构有些类似于FFT中的结构，是一种对数结构。一个n维的蝶形拓扑结构由2n个IP核和n×(2n-1)个路由器的节点组成，路由器分为n层，每层有N/2个路由器。
![在这里插入图片描述](52f91aefe06ad3f0705f73b7cc54e36f.png)
