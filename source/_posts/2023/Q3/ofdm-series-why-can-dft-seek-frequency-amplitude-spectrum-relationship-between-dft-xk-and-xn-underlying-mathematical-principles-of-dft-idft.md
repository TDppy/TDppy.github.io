...
@[TOC]
## 问题引入
![在这里插入图片描述](c4245f2374669972b1dfcc690cef7fb3.png)
...
![在这里插入图片描述](f15297ec74d13b6a0d32ae1ac64e9474.png)
...
![在这里插入图片描述](8e626dc6968c597f2ae8b9f944fe91bf.png)

## DFT公式证明
我将公式的证明整理成了PPT，下面我直接复制，在证明中使用到了上面铺垫的小公式，注意关联起来看就可以理解了！
### DFT公式分解为4部分
![在这里插入图片描述](bd70c807a23d281d759cc053cc3fd4a0.png)
#### 先考虑k1=0的情况:
![在这里插入图片描述](7ce8da81c906de1256e20ae46e743b79.png)
#### 再考虑k1≠0的情况:
![在这里插入图片描述](14d7f5c35d28e2fa97b11a488cd5c70f.png)
![在这里插入图片描述](93bf801afbbd316d07d185d39781c540.png)
![在这里插入图片描述](fd6805795ecf0b576896897d2685555d.png)
![在这里插入图片描述](d7837eeb26648d6ffb6a1fdd0fca65f8.png)
![在这里插入图片描述](ab181746a8c84a4b39d885323267afc1.png)
### DFT计算后，X(k)与x(n)的关系：
![在这里插入图片描述](d4578828ffea0dc39b9264d62f723a9c.png)
...
## IDFT公式证明
![在这里插入图片描述](dfbfd3c1ff7f6abfcecd14efa3ad09e0.png)
