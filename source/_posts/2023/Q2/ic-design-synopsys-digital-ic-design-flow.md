...
## 前端设计
### RTL编写和HDL仿真
![在这里插入图片描述](c33fa49085488d1e8020ccfeec2d4303.png)
...
![在这里插入图片描述](f2c18dd2e965e5064f5e8cb386b861eb.png)

具体来说，DC实际上将RTL先翻译成 了内部可识别的GTECH形式的中间代码，然后再根据所提供的**目标库**和**设计约束**来映射和优化出最终的网表文件netlist.v。
![在这里插入图片描述](712b74c3a428b41545a741a4ba746000.png)

![在这里插入图片描述](fecdf4ae29eb6ae43958ff294ee160d6.png)
...
## 后端设计
![在这里插入图片描述](94aaa8ef90929669b00c4149fb21a502.png)
...
![在这里插入图片描述](40e7af444f9fe981bf828c78a266298e.png)
### 数据准备
...
#### set mw_phys_refs *
 ...
 ![在这里插入图片描述](ec5d81347913eade3227219bda85f4cd.png) ![在这里插入图片描述](edf127a984f2f30d7f346a0003c6a7d0.png)
#### set link_library *
...
![在这里插入图片描述](498f01e548b6bc83aa8261a55fb2ea7e.png)
#### 数据准备 (SDC)
•  SDC是一个设计中至关重要的一部分，它对电路的时序、面积、功耗进行约束，是设计的命 脉，决定了芯片是否满足设计要求的规范。
![在这里插入图片描述](0ed58732b7d05fb232d68fc548778f6b.png)
![在这里插入图片描述](adab953c517fa176139224a57a5ca83b.png)
...
![在这里插入图片描述](8d4a34f62b76d50fd0fb8eb5ff64e3da.png)
...
![在这里插入图片描述](e32391e0829e3b280c44a689ec9915d1.png)
...
- Placement Legalization：标准单元放置在row上，保证所有cell处于legal的状态
  ![在这里插入图片描述](5901f97d9107817f757e96f3e551693c.png)
...
![在这里插入图片描述](5e6ffba674dcb054fbc2a18bb0cd8743.png)
...
-  Search and repair: 通过逐渐增大Sbox的尺寸,寻找和消除Detail routing中没有完全消除的DRC违规。
  ![在这里插入图片描述](aa965270fcb7f0befe91a404bd1583de.png)
  布线后的图（可以看到除了之前时钟树的连线外，增加了对各个模块的连线）
![在这里插入图片描述](7f7ab3b6eebc92218ccb6eef5bdbc712.png)
