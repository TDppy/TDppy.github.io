...
如图所示，我们的目标是每1.5个周期翻转一次，那么可以这样做，得到一个占空比为50%的奇数分频。
 ...
 3. out_clk就是分频的结果
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2935ac82c26f9263734cbd3938195458.png)
...
```
## 偶数分频的电路仿真波形
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a84545e0f89426f7a5c5102d246e58d9.png)
...
## 占空比为50%的三分频电路仿真波形
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6607ffa2c18e0df38d9e16279549341d.png)
# 参考资料
