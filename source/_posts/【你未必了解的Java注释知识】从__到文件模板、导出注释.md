...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d3142e4003c2f2805b22558952c34eed.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/996c7baeb729762d8302fbd7819adb8e.png)
如果我们想要在类创建时就自动为我们添加好上面2~7行的注释，应该怎么做？
这里介绍下IntelliJ IDEA中的做法，如果使用其他IDE的朋友自行搜索下。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c495b42191cb713b2466c16b331a7dc8.png)
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/86a7606927fc972fce7e57c0660ae014.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1cbe769976d127d5a86e47e00e864d3f.png)
具体怎样操作？
由于不清楚看教程同学的基础，这里以最简单的方式来讲，如果有基础的同学相信能自行变通。

 **1.** 在桌面建立一个文件夹，命名为FILE
 **2.** 复制你的Person.java类到FILE文件夹中
 **3.** 见图![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d468b19a728ae79dbf1353db282fbb68.png)
**4.**写好后回车，此时会进入当前目录的控制台，输入这样一条命令并回车：

```bash
javadoc -d . -version -author Person.java
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/05b3cd27a83bd2682cb5efd67aedbc31.png)
