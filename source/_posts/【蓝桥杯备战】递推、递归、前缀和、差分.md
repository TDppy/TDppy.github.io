...
首先是递推，洛谷P1255 数楼梯。
阶梯思路如图：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8e04f6750a426a69576e9eba382f20ee.png)
...
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/14ee79fc50d710dbf072e7c087f3d548.png)
当求和后超过10时进位，将其十位给右面的元素，个位赋值给自己，进位的同时让len++，表示目前有2位数。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/af0f51115028361a0b187e740e54d9c2.png)
