...
这个报错实际上告诉我们，在build.sbt中**指定的依赖没有下载到**，导致依赖的结构无法实现。
 ![ ](/images/0fb7ac24301b85a05f75cda273f9e241.png) 
...
```
 ...
 ![ ](/images/07d7ee342a15b61deaca5f3278a6cb95.png) 
## ②更改下载源为华为的镜像站
...
为true表示sbt构建的仓库下载源将自定义。
 ![ ](/images/452156f37bd5612bc839458b986e3600.png) 
...
```
 ![ ](/images/28e0b63f5e43c61d216ef44fab9e16d3.png) 
...
```
 ...
 ![ ](/images/ab2816c3ccb1e8008310369afe96d8f4.png) 
...
点进chisel3 2.13中发现确实没有3.4.3
 ![ ](/images/a54a99a23f960a9c096338118abc900e.png) 
 ![ ](/images/ab0cc26f439178b4f4acda38993a1b19.png) 
返回，去看chisel3 2.11的目录 发现确实有3.4.3的chisel适配版本
 ![ ](/images/bc497e8e9faa91b303db0007d15de436.png) 
